...
const ProyectoA = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-cyan-700 to bg-slate-800 text-white">
            {/* Botón de regreso */}
            <button
            ...
            <div className="container mx-auto px-8 py-20">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-xl text-gray-300 mb-12" style={{ fontFamily: 'Georgia, serif' }}>
                        Proyecto personal, plataforma de gestión de proyectos y tareas.
                    </p>
                    ...
                    <div>
                        <button className="ml-5 bg-gray-200/20 hover:bg-gray-300/60 text-white font-bold py-2 px-4 rounded-xl transition-colors" onClick={() => window.open('https://horizon-company.com', '_blank')}>
                            Ver Mas
                        </button>
                    </div>
